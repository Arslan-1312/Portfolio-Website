...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-white/5 py-12 relative z-20 bg-slate-950/40 backdrop-blur-md">
      {/* Footer content slides up gently when it enters view */}
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        transition={{ type: 'spring', stiffness: 90, damping: 18 }}
        className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center justify-between gap-6"
      >
        {/* Left: Logo + copyright */}
        <div className="text-center md:text-left">
          <motion.div
            ...
            className="text-xl font-bold bg-gradient-to-r from-primary-cyan via-primary-blue to-primary-purple bg-clip-text text-transparent cursor-pointer inline-block mb-2"
          >
            Arslan Iqbal
          </motion.div>
