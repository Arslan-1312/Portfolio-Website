...
// Zod schema for contact form — validation rules unchanged
...
// FormField component decoupled outside to preserve keystroke focus context
const FormField = ({ label, name, type = 'text', icon: Icon, isTextarea = false, register, errors, watch, textareaRef }) => {
  ...
  return (
    // Wrapper smoothly fades in with a subtle upward slide when it enters view
    <motion.div
      initial={{ opacity: 0, y: 12 }}
      whileInView={{ opacity: 1, y: 0 }}
      viewport={{ once: true }}
      transition={{ duration: 0.4, ease: 'easeOut' }}
      className="relative mb-6 text-left group"
    >
      {/* Icon inside input — turns cyan when focused */}
      ...
      {/* Floating label — lifts above the input when focused or filled */}
      <label
        htmlFor={name}
      ...
      {/* Error message slides down smoothly when validation fails */}
      <AnimatePresence>
        {errors[name] && (
          <motion.p
...
export default function Contact() {
  ...
  // Formspree submission — logic is completely unchanged
    ...
    <section id="contact" className="relative py-20 px-4 md:px-8 overflow-hidden z-10">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          {/* Badge gliding up as the section enters view */}
          <motion.div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          {/* ── Left Column: Contact info slides in from the left ── */}
          <motion.div
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <motion.div
                ...
                className="flex items-center gap-4 p-4 rounded-2xl glass-card border border-white/5 hover:border-primary-cyan/20 transition-all duration-300 group"
              >
                ...
                <div>
                  ...
                  <a href="mailto:arslaniqbal4666@gmail.com" className="text-sm font-bold text-white hover:text-primary-cyan transition-colors">
              ...
              <motion.div
                whileHover={{ x: 4, transition: { type: 'spring', stiffness: 400, damping: 20 } }}
                className="flex items-center gap-4 p-4 rounded-2xl glass-card border border-white/5 hover:border-primary-purple/20 transition-all duration-300 group"
              >
                ...
                <div>
                  ...
                  <a href="tel:+923135180543" className="text-sm font-bold text-white hover:text-primary-purple transition-colors">
                    +92 313-5180543
                  </a>
                </div>
              </motion.div>
              ...
              <motion.div
                whileHover={{ x: 4, transition: { type: 'spring', stiffness: 400, damping: 20 } }}
                className="flex items-center gap-4 p-4 rounded-2xl glass-card border border-white/5 hover:border-primary-blue/20 transition-all duration-300 group"
              >
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-white">Mansehra, KPK, Pakistan</p>
                </div>
              </motion.div>
            </div>
          ...
          {/* ── Right Column: Form card slides in from the right ── */}
          <motion.div
            initial={{ opacity: 0, x: 35 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="relative z-10">
              ...
              {/* Status banner fades in on success or error */}
              <AnimatePresence>
                {statusMessage && (
                  <motion.div
              ...
              <div className="w-full pt-2">
                <MagneticButton className="w-full">
                  ...
                  >
                    {/* Shimmer highlight that sweeps across the button on hover */}
                    ...
                    {formStatus === 'sending' ? (
                      <>
                        <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-white-pure" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                      ...
                      <>
                        ...
                        {/* Arrow icon glides forward and up on hover */}
