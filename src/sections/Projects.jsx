          ...
          <AnimatePresence mode="popLayout">
            {filteredProjects.map((project) => (
              <motion.div
                ...
                className="glass-card rounded-2xl overflow-hidden border-white/5 hover:border-primary-cyan/30 transition-all duration-300 flex flex-col group shadow-2xl"
              >
                {/* Project Image */}
